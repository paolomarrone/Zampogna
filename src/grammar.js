...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[2,3],$V1=[1,4];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"program":3,"program_stmts_0":4,"program_stmt":5,"END":6,"$accept":0,"$end":1},
terminals_: {2:"error",6:"END"},
productions_: [0,[3,1],[4,2],[4,0],[5,1]],
...
table: [{1:$V0,3:1,4:2,5:3,6:$V1},{1:[3]},{1:[2,1]},{1:$V0,4:5,5:3,6:$V1},o([1,6],[2,4]),{1:[2,2]}],
